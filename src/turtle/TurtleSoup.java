...
public class TurtleSoup {
    ...
    public static void drawRegularPolygon(Turtle turtle, int sides, int sideLength) {
        ...
        DrawableTurtle dt=new DrawableTurtle();
        dt.CurrentColor = PenColor.GREEN;
        turtle.forward(sideLength);
        turtle.turn(rotation);
        turtle.forward(sideLength/10*3);
        turtle.turn(-90);
        turtle.forward(sideLength/10*3);
        turtle.turn(90);
        turtle.forward(sideLength/5);
        turtle.turn(90);
        turtle.forward(sideLength/10*3);
        ...
        turtle.forward(sideLength/10*3);
        turtle.turn(rotation);
        turtle.forward(sideLength/10*2);
        turtle.turn(rotation);
        turtle.forward(sideLength/10*2);
        turtle.turn(rotation);
        turtle.forward(sideLength/10*3);
        ...
        turtle.turn(180);
        turtle.forward(sideLength+sideLength/2);
        turtle.turn(120);
        for(int i = 0; i < sides; i++){
            turtle.forward(sideLength/2);
            turtle.turn(rotation);
